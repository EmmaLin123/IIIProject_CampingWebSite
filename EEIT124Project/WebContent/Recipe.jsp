...
<a href="<c:url value='./ShowRecipeCartContent.jsp?page=${page}' />"><svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-cart4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" float="right">
